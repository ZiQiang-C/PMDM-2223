...
public class ModListaBebida extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        image=findViewById(R.id.modImage);
        creatORM();
        asigBebida();
        ...
        imgResult = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(),
                result -> {
                    if (result.getResultCode()==RESULT_OK){
                        ...
                        image.setImageURI(uriCapturada);
    ...
    public void imageClick(View v){
        if (ContextCompat.checkSelfPermission(
                ModListaBebida.this, Manifest.permission.READ_EXTERNAL_STORAGE) ==
    ...
    public void asigBebida () {
        ...
        image.setImageURI(Uri.parse(extras.getString("img")));
    }
    public void borrar() {
        List<BebidaTable> bebidadb = bebidaTableDao.getAll();
        for (BebidaTable x : bebidadb) {
            if (x.nombre.equals(Tnombre.getText().toString())) {
